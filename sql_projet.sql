...
CREATE TABLE Client(
   ...
   prenom_client VARCHAR(50), -- ville/ ville id
   adresse VARCHAR(50),
...
INSERT INTO Achat (id_achat, date_achat, date_installation, id_client, numero_pompe, prix_achat) VALUES
(1, '2023-01-01', '2023-01-10', 1, 1, 2100),
(2, '2023-02-02', '2023-02-12', 2, 2, 1600),
(3, '2023-03-03', '2023-03-13', 3, 3, 2800),
(4, '2023-04-04', '2023-04-14', 4, 4, 2300),
(5, '2023-05-05', '2023-05-15', 5, 5, 2400),
(6, '2023-06-10', '2023-06-15', 1, 2, 1600),
(7, '2023-07-05', '2023-07-12', 2, 1, 2100),
(8, '2023-08-20', '2023-08-25', 3, 3, 2800),
(9, '2023-09-15', '2023-09-18', 4, 2, 1600),
(10, '2023-10-10', '2023-10-20', 5, 1, 2100);
